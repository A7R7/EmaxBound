...
(custom-set-faces
 ...
 '(custom-button ((t (:box (:line-width (1 . 1) :style none) :foreground "#73d0ff" :background "#1f2430" :inherit 'variable-pitch))))
 '(custom-documentation ((t (:inherit variable-pitch))))
 '(custom-face-tag ((t (:inherit (custom-variable-tag variable-pitch)))))
 '(custom-link ((t (:inherit (link variable-pitch)))))
 '(custom-variable-tag ((t (:foreground "#d4bfff" :inherit variable-pitch))))
 ...
 '(diredfl-autofile-name ((t (:foreground "#f5f7fd" :inherit variable-pitch))))
 '(diredfl-dir-name ((t (:weight semi-bold :foreground "#73d0ff" :inherit variable-pitch))))
 '(diredfl-file-name ((t (:foreground "#cbccc6" :inherit variable-pitch))))
 '(diredfl-symlink ((t (:foreground "#dccbff" :inherit variable-pitch))))
 '(dirvish-collapse-dir-face ((t (:inherit (variable-pitch dired-directory)))))
 '(dirvish-collapse-empty-dir-face ((t (:inherit (variable-pitch shadow)))))
 '(dirvish-collapse-file-face ((t (:inherit (variable-pitch default)))))
 '(dirvish-file-modes ((t (:inherit (font-lock-builtin-face variable-pitch)))))
 '(dirvish-file-size ((t (:slant normal :underline nil :inherit completions-annotations))))
 '(dirvish-hl-line ((t (:extend nil :inherit highlight))))
 '(dirvish-media-info-heading ((t (:inherit (dired-header bold variable-pitch)))))

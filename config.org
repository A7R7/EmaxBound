...
#+end_src
** Window center 
[[https://github.com/joostkremers/visual-fill-column][visual-fill-column]] is a small Emacs minor mode that mimics the effect of fill-column in visual-line-mode. Instead of wrapping lines at the window edge, which is the standard behaviour of visual-line-mode, it wraps lines at fill-column.
...
Use visual-fill-column to center text in minibuffer.
Have some bugs.
#+begin_src elisp
...
Use visual-fill-column to center magit
#+begin_src elisp
...
**** Org-morden
[[https://github.com/minad/org-modern][org-morden]] implements a modern style for Org buffers using font locking and text properties. The package styles =headlines=, =keywords=, =tables= and =source blocks=. 

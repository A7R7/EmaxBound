...
There're 3 modes that can center text in a window
...
*** Visual-fill-column
 ...
 [[https://github.com/joostkremers/visual-fill-column][visual-fill-column]]  asdf
...
- Org-dynamic-bullets :: handles the dynamic bullets. =May broke highlight=.
